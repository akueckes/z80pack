...
#ifdef HAS_MUSICBOARD
	[ 36] = newtech_musicboard1_out,	/* first Newtech Model 6 Music Board */
#else
...
#ifdef HAS_MUSICBOARD
	[ 40] = newtech_musicboard2_out,	/* second Newtech Model 6 Music Board */
#else
